...
alias g--since='git 6-weeks-ago \'
alias gtime_min='git  systime(); time_max = 0; \'
alias gSECONDS_PER_DAY='git 86400; \'
alias gslot='git  time_to_slot(time); \'
alias gtime_max_add='git  time_max += SECONDS_PER_DAY; \'
alias grow='git  \"\"; \'
alias gslot='git  time_to_slot(time); \'
alias gcount='git  views[item, slot]; \'
alias grow='git  row count_to_char(count); \'
