...
export CRABBOX_TRUSTED_USER_HEADER="${CRABBOX_TRUSTED_USER_HEADER:-Cf-Access-Authenticated-User-Email}"
export CRABBOX_TRUSTED_USER_ORG="${CRABBOX_TRUSTED_USER_ORG:-${CRABBOX_DEFAULT_ORG:-personal}}"
