...
Describe 'home-manager/modules/yek/install-yek-shim.sh'
SCRIPT="$PWD/home-manager/modules/yek/install-yek-shim.sh"
...
It 'references @install_yek_script@'
When run bash -c "grep '@install_yek_script@' '$SCRIPT'"
The output should include '@install_yek_script@'
End
