...
@test "no args calls pi with templated cliproxyapi model" (grep -c "cliproxyapi/__DEEPSEEK_FLASH__" $log1) -ge 1
...
@test "with args uses templated cliproxyapi model" (grep -c "cliproxyapi/__DEEPSEEK_FLASH__" $log2) -ge 1
