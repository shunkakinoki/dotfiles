...
verify that git-notes is pushing while in the last commit?

### Prompt 13

how is git-ai installed? ~/.git-ai/bin/git

### Prompt 14

yea i want to get it managed by nix..
...
but still managed by cargo

### Prompt 17

yes put it in home-manager modules git?
